        ...
        while True:
            ...
            if high_streak is not None:
                ...
                if not 4 < next_quiz.hour < 13:
                    await channel.send("{} is on a {}-streak! Next quiz will be at approximately {}:{}. Shut them down!".format(self.bot.get_user(high_streak[0]).name, high_streak[1], (next_quiz - datetime.timedelta(hours=5)).hour, next_quiz.minute))
