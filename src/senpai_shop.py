...
class SenpaiGacha:
    ...
    async def draw_battle(self, username1, pokemon1, str_poke1_plus, poke1_bst, str_poke1_bst_bonus, poke1_odds,
        ...
        draw.text((35, 85), "{}".format(username2), (255, 255, 255), font=font)
        draw.text((35, 95), "{}{}".format(pokemon2, str_poke2_plus), (255, 255, 255), font=font)
        draw.text((35, 105), "BST: {}{}".format(poke2_bst, str_poke2_bst_bonus), (255, 255, 255), font=font)
        draw.text((35, 115), "Odds: {}%".format(poke2_odds), (255, 255, 255), font=font)
        draw.text((35, 125), "Balance: {} pikapoints".format(p2_balance), (255, 255, 255), font=font)
        draw.text((35, 135), "Earnings: {} pikapoints".format(p2_win_payout), (255, 255, 255), font=font)

        draw.text((535, 285), "{}".format(username1), (255, 255, 255), font=font)
        draw.text((535, 295), "{}{}".format(pokemon1, str_poke1_plus), (255, 255, 255), font=font)
        draw.text((535, 305), "BST: {}{}".format(poke1_bst, str_poke1_bst_bonus), (255, 255, 255), font=font)
        draw.text((535, 315), "Odds: {}%".format(poke1_odds), (255, 255, 255), font=font)
        draw.text((535, 325), "Balance: {} pikapoints".format(p1_balance), (255, 255, 255), font=font)
        draw.text((535, 335), "Earnings: {} pikapoints".format(p1_win_payout), (255, 255, 255), font=font)
