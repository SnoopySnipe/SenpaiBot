...
class SenpaiGacha:
    ...
    async def draw_battle(self, username1, pokemon1, str_poke1_plus, poke1_bst, str_poke1_bst_bonus, poke1_odds,
        ...
        draw.text((38, 103), "{}{}".format(pokemon2, str_poke2_plus), (255, 255, 255), font=font)
        draw.text((38, 118), "BST: {}{}".format(poke2_bst, str_poke2_bst_bonus), (255, 255, 255), font=font)
        draw.text((38, 133), "Odds: {}%".format(poke2_odds), (255, 255, 255), font=font)
        draw.text((38, 148), "Balance: {} pikapoints".format(p2_balance), (255, 255, 255), font=font)
        draw.text((38, 163), "Earnings: {} pikapoints".format(p2_win_payout), (255, 255, 255), font=font)

        draw.text((538, 288), "{}".format(username1), (255, 255, 255), font=font)
        draw.text((538, 303), "{}{}".format(pokemon1, str_poke1_plus), (255, 255, 255), font=font)
        draw.text((538, 318), "BST: {}{}".format(poke1_bst, str_poke1_bst_bonus), (255, 255, 255), font=font)
        draw.text((538, 333), "Odds: {}%".format(poke1_odds), (255, 255, 255), font=font)
        draw.text((538, 348), "Balance: {} pikapoints".format(p1_balance), (255, 255, 255), font=font)
        draw.text((538, 363), "Earnings: {} pikapoints".format(p1_win_payout), (255, 255, 255), font=font)
